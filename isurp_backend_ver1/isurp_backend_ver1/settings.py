"""
Django settings for isurp_backend_ver1 project.
...
SECRET_KEY = '8qrz35o1f0=z=@o(q=9di5i)o*2n*n50*+tqa-$s379^bvqb$+'
...
ROOT_URLCONF = 'isurp_backend_ver1.urls'
...
WSGI_APPLICATION = 'isurp_backend_ver1.wsgi.application'
